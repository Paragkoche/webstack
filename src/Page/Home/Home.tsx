    ...
    <>
                    ...
                    <div className="text-center-mbl">
                      ...
                      <div className="inner-container _591px">
                        <p className="mg-bottom-40px">
                          ...
                          neque ultrices viverra nam libero justo{" "}
                          <span className="text-no-wrap">laoreet sit.</span>
                        </p>
                      </div>
              ...
              {[
                {
                  ...
                  para: "Lorem ipsum dolor sit amet consectoli tur adipiscing elit semper dalar.",
                },
                {
                  image: img2,
      ...
      <section className="section wf-section">
        <div className="container-default w-container">
          ...
          <div
       data-delay="4000" data-animation="slide"  data-autoplay="false" data-easing="ease"  data-hide-arrows="false" data-disable-swipe="false" data-w-id="c55f9bef-5874-4fd3-32f0-b8e103502d24" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true" role="region" aria-label="carousel"
          ...
          >
            <div
              ...
              id="w-slider-mask-0"
            >
              {[{image:"",name:"",bio:""},{image:"",name:"",bio:""},{image:"",name:"",bio:""},{image:"",name:"",bio:""}].map((v,i)=>(
                <div
                ...
                <div className="w-dyn-list">
                  <div role="list" className="w-dyn-items">
                    <div role="listitem" className="w-dyn-item">
                      <Link
                        to="#"
                        className="card link-card post-item w-inline-block"
                      >
