...
export default () => {
  ...
  return (
    ...
    <div className="header-wrapper w-nav" data-w-id="9b01b8db-8988-0b69-ea7c-bf010248db31" data-collapse="medium">
      <div className="container-default header w-container">
        <div className="header-content-wrapper">
            ...
            <nav className="header-nav-menu-wrapper w-nav-menu">
              <ul className="header-nav-menu-list">
                <li className="header-nav-list-item middle">
                  <Link to="/" className="header-nav-link w-nav-link w--current">
                    Home
                  </Link>
                </li>
                <li className="header-nav-list-item middle">
                ...
                <li className="header-nav-list-item show-in-tablet header-nav-btn"><Link to="/contact" className="btn-primary width-100 w-button">Contact us</Link></li>
              </ul>
            </nav>
          </div>
          <div className="header-right-side">
            ...
            <div
              onClick={()=>isOpen((s)=>!s)}
              className={open?"hamburger-menu-wrapper w-nav-button w--open":"hamburger-menu-wrapper w-nav-button"}
              aria-label="menu"
              role="button"
